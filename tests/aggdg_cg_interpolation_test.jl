...
L0 = aggmg.aggdg_cg_interpolation( aggMesh, baseMesh, mesh, 0 );
...
L0 = sp.sparse(L0);
L1 = aggmg.aggdg_cg_interpolation( aggMesh, baseMesh, mesh, 1 );
L2 = aggmg.aggdg_cg_interpolation( aggMesh, baseMesh, mesh, 2 );
...
L = aggmg.aggdg_cg_interpolation( aggMesh, baseMesh, mesh, interpFlag );
